...
local walkSpeedVal = 30

-- UI SETUP
local gui = Instance.new("ScreenGui")
gui.Name = "hyzer_speed_boost"
...
createModule("Speed", "F", 55, function() speedActive = not speedActive return speedActive end, 1, 300, 30, function(v) walkSpeedVal = v end)

local footer = Instance.new("TextLabel")
footer.Size = UDim2.new(1, 0, 0, 30)
footer.Position = UDim2.new(0, 0, 1, -25)
footer.Text = "discord.gg/WrWmUSgNbs"
